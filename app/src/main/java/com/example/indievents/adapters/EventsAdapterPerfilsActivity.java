...
public class EventsAdapterPerfilsActivity<T> extends ArrayAdapter<T> {
    private int layout;
    public EventsAdapterPerfilsActivity(Context context, List<T> objects, @LayoutRes int layout) {
